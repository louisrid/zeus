...
import { EXTERNAL_XPTS_GW_FROM, EXTERNAL_XPTS_GW_TO } from "./external_xpts.mjs";

/* The optimiser's gameweek bounds are the served external-xPTS horizon, read from
 * config/external-xpts-2026-27.mjs. They were literals here, which silently rejected
 * ranges the data could answer whenever gw_served_to moved ahead of them. Raising
 * gw_served_to is now the only knob. Never write a literal back into these. */
export const OPTIMISE_GW_MIN = EXTERNAL_XPTS_GW_FROM;
export const OPTIMISE_GW_MAX = EXTERNAL_XPTS_GW_TO;

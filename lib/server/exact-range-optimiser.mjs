...
export async function buildExactSquadForRange({
  ...
  /* The rejected values are named. "must be within GW1-GW38" alone gave no way to tell an inverted
     range from an out-of-bounds one, and an inverted range reaching here from a stale dropdown took a
     long time to find precisely because the message did not say what it had been given. */
  if (!range) {
    return { ok: false,

...
export const UPGRADES = {
  score: "7 AUG",     // calibration + ablation complete (campaign plan, week 2)
  minutes: "1 AUG",   // fatigue study feeds the minutes model's World Cup load values
  structure: "3 AUG", // strategy study sets structure evidence scores
};
...
export function buildScorer({ projections, archivePer90, understat, envByTeam, leagueMeanGoals, goalPoints, assistPoints, appearancePoints }) {
